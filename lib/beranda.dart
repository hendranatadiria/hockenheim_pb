...
class _BerandaViewState extends State<BerandaView> {
  ...
  getPosts() async {
    var response = await http.get(_appConfig.getApiBaseUrl() + 'api/post/');
  ...
  Widget build(BuildContext context) {
    return posts==null?Scaffold(body: Center(child: CircularProgressIndicator(),)):SingleChildScrollView(
      ...
      child: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text('Postingan terbaru:', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),),
            SizedBox(height: 16,),
            ListView.builder(
